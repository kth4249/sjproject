               ...
               function() {
                  ...
                  $id.on("input", function() {
                     ...
                     if (!regExp.test($id.val())) {
                        $("#checkId").text("아이디 형식이 유효하지 않습니다.").css(
                              "color", "red");
                        ...
                        $.ajax({
                        	...
                        	success : function(result){
                        		if(result == "yes"){
                        			$("#checkId").text("사용 가능한 아이디 입니다.").css(
                                            "color", "green");
                        			
                        			signUpCheck.idDup = true;
                        		}else{
                        			$("#checkId").text("사용할 수 없는 아이디 입니다.").css(
                                            "color", "red");
                  ...
                  $pwd1.on("input", function() {
                     ...
                     if (!regExp.test($pwd1.val())) {
                        ...
                        $("#checkPwd1").text("유효한 형식의 비밀번호 입니다.").css(
                              "color", "green");
                  ...
                  $pwd2.on("input", function() {
                     if ($pwd1.val().trim() != $pwd2.val().trim()) {
                        $("#checkPwd2").text("비밀번호가 일치하지 않습니다.").css(
                              "color", "red");
                  ...
                  $email.on("input", function() {
                     ...
                     if (!regExp.test($email.val())) {
                        ...
                        $("#checkEmail").text("유효한 형식의 이메일 입니다.").css(
                              "color", "green");
