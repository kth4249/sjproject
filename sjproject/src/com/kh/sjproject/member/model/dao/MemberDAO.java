...
public class MemberDAO {
	 ...
	 * @throws Exception
	 */
	public int signUpMember(Connection conn, Member member) throws Exception {
		PreparedStatement pstmt = null;
		int result = 0;
	...
	public int updateMember(Connection conn, Member updateMember) throws Exception{
		...
		try {
			pstmt = conn.prepareStatement(query);
			pstmt.setString(1, updateMember.getMemberPhone());
			pstmt.setString(2, updateMember.getMemberEmail());
			pstmt.setString(3, updateMember.getMemberAddress());
			pstmt.setString(4, updateMember.getMemberInterest());
